...
GAMES = {
    "Asteroid Game": "game-D.Alvarez.Corres/",
    "Black Hole Game": "game-S.Leszek/",
    "Colour Matcher": "game-M.Gerritsen/",
    "Save the Ship": "game-M.Boer/",
    "Space Rescue Game": "game-N.Demmenie/",
    "test3": "test",
    "test4": "test",
    "test5": "test",
    "test6": "test",
